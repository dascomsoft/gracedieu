...
//                 <div className="flex flex-col lg:flex-row justify-between items-start gap-2 print:gap-1 mt-10 mb-20 print:mb-1" style={{ fontSize: '9px' }}>

//                     {/* Légende des Appréciations */}
//                     <div className="w-full lg:w-1/4 border border-gray-300 rounded p-1 mb-4 lg:mb-0">
...
//                     {/* Résumé du Travail */}
//                     <div className="w-full lg:w-1/4 border-2 border-gray-400 rounded p-1 mb-4 lg:mb-0">
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-2 flex flex-col items-center print:p-0 print:bg-white">
            ...
            <div className="bg-white w-full max-w-4xl shadow-sm p-3 print:shadow-none print:max-w-full print:p-2" style={{ minHeight: '27.5cm' }}>
                ...
                {/* Section inférieure avec disposition flexible */}
                <div className="flex flex-col gap-4 mt-3 mb-3 print:mb-0 print:gap-1 md:flex-row md:flex-wrap md:justify-between md:items-start md:gap-2 lg:flex-nowrap text-[9px]">
                ...
                {/* Contact */}
                <div className="text-center text-[9px] bg-blue-50 border border-blue-200 rounded p-1 mt-1 print:mt-1 mb-3">
                    <div className="font-bold text-blue-800">Téléphone: +237 696 308 503 | Siège Social: Yaoundé - Nkolbisson (Quartier Mbouda)</div>
                </div>
            </div>
