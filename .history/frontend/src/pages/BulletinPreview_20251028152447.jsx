...
const BulletinPreview = () => {
    ...
    "
                ...
                {/* Responsive Lower Section - English version */}
<div
  className="
...
>
  ...
  <div className="w-full md:w-[48%] lg:w-1/4 border border-gray-300 rounded p-2">
    <div className="font-semibold text-center mb-1">Appreciation Legend</div>
    <div className="space-y-0.5">
      <div><strong>Acquired</strong> - The student has mastered the skill</div>
      <div><strong>In the process of acquire</strong> - Progressing but not yet mastered</div>
      <div><strong>Expert</strong> - Performance above expectations</div>
  ...
  {/* Periods */}
  <div className="w-full md:w-[48%] lg:w-1/4 border border-gray-300 rounded p-2">
    <div className="font-semibold text-center mb-1">Periods</div>
  ...
  <div className="w-full md:w-[48%] lg:w-1/4 border-2 border-gray-400 rounded p-2">
    <div className="font-semibold text-center mb-1">Summary of Work</div>
        ...
        <div key={role} className="border border-gray-300 rounded p-2 text-center">
          ...
          <div className="h-8 mt-0.5 flex items-center justify-center">
            {/* <span className="text-gray-500 text-[7px]">Signature & stamp</span> */}
                ...
                {/* Contact  */}
                <div className="text-center text-[9px] bg-blue-50 border border-blue-200 rounded p-1 mt-20 print:mt-1">
